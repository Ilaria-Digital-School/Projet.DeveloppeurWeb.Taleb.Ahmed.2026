-- =====================================================
-- Base de données pour Vagues de Riffs
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Table des utilisateurs du site Vagues de Riffs';
...
CREATE TABLE newsletter_subscribers (
    ...
    INDEX idx_subscribedAt (subscribed_at)
...
INSERT INTO users (firstName, lastName, email, username, password, birthDate, role, isActive) VALUES (
    'Admin', 
    'Vagues de Riffs', 
...
/*
-- Insertion de concerts exemples
INSERT INTO concerts (title, venue_name, venue_address, venue_city, venue_capacity, concert_date, concert_time, price_min, price_max, price_currency, description, status, ticket_url, info_url, image, is_featured, created_by) VALUES 
('Vagues de Riffs - Lancement du Nouvel Album', 'Olympia', '28 Boulevard des Capucines', 'Paris', 2000, '2024-06-15', '20:00', 35.00, 75.00, 'EUR', 'Soirée exceptionnelle pour le lancement de notre nouvel album "Résonances". Une nuit de rock pur avec des invités spéciaux.', 'upcoming', 'https://billetterie.vaguesderiffs.fr/olympia', 'https://vaguesderiffs.fr/concert/olympia', 'https://picsum.photos/seed/concert-olympia/800/600.jpg', TRUE, 1),
('Festival Rock en Seine', 'Parc des Expositions', 'Place de la Concorde', 'Paris', 5000, '2024-07-20', '18:00', 45.00, 89.00, 'EUR', 'Vagues de Riffs en tête d\'affiche du plus grand festival rock de l\'été.', 'upcoming', 'https://billetterie.vaguesderiffs.fr/festival-seine', 'https://vaguesderiffs.fr/festival-seine', 'https://picsum.photos/seed/festival-seine/800/600.jpg', TRUE, 1),
('Session Acoustique Intime', 'Le Petit Journal', '12 Rue de la Ferronnerie', 'Lyon', 150, '2024-05-10', '19:30', 20.00, NULL, 'EUR', 'Une soirée acoustique unique dans un cadre intimiste. Places très limitées.', 'sold_out', '', 'https://vaguesderiffs.fr/lyon-acoustic', 'https://picsum.photos/seed/lyon-acoustic/800/600.jpg', FALSE, 1),
('Concert Anniversaire - 5 Ans', 'L\'Aéronef', '20 Quai Palmer', 'Cenon', 3000, '2024-09-15', '19:00', 25.00, 65.00, 'EUR', 'Célébration de nos 5 ans de carrière ! Un concert spécial avec beaucoup de surprises.', 'upcoming', 'https://billetterie.vaguesderiffs.fr/5-ans', 'https://vaguesderiffs.fr/5-ans', 'https://picsum.photos/seed/concert-5ans/800/600.jpg', TRUE, 1);

-- Insertion d'éléments du portfolio exemples
INSERT INTO portfolio (title, description, image, category, is_featured, created_by) VALUES 
('Premier Album - Première Vague', 'Notre premier EP enregistré dans les conditions mythiques du rock. 5 titres qui définissent notre son unique.', 'https://picsum.photos/seed/album-premiere-vague/800/600.jpg', 'album', TRUE, 1),
('Clip Vidéo - Écho Urbain', 'Notre premier clip tourné dans les rues de Paris. Une explosion visuelle et sonore.', 'https://picsum.photos/seed/clip-echo-urbain/800/600.jpg', 'video', TRUE, 1),
('Session Studio - Résonances', 'L\'enregistrement de notre album "Résonances" dans le studio mythique de la Seine.', 'https://picsum.photos/seed/studio-resonances/800/600.jpg', 'studio', FALSE, 1),
('Tournée 2023 - Vagues Françaises', 'Notre première tournée nationale qui nous a menés dans les plus grandes villes de France.', 'https://picsum.photos/seed/tournee-2023/800/600.jpg', 'concert', TRUE, 1),
('Festival Les Vieilles Charrues', 'Notre performance mémorable au plus grand festival de l\'Ouest de la France.', 'https://picsum.photos/seed/festival-vieilles-charrues/800/600.jpg', 'festival', FALSE, 1),
('Session Acoustique - Radio France', 'Session live acoustique enregistrée exclusivement pour les antennes de Radio France.', 'https://picsum.photos/seed/acoustic-radio-france/800/600.jpg', 'acoustic', FALSE, 1);
